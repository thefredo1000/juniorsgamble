...
LIBBUTANO   	:=  ../../butano
PYTHON      	:=  python
SOURCES     	:=  src src/poker_port ../../common/src
INCLUDES    	:=  include include/poker_port ../../common/include
DATA        	:=
GRAPHICS    	:=  graphics world_map/graphics ../../common/graphics
AUDIO       	:=  audio
DMGAUDIO    	:=
ROMTITLE    	:=  JUNIORS GAMBLE
ROMCODE     	:=  SBTP
USERFLAGS   	:=  -flto -Os
USERCXXFLAGS	:=  -DPOKER_DISABLE_STANDALONE_MAIN
USERASFLAGS 	:=  
USERLDFLAGS 	:=  -flto=4
USERLIBDIRS 	:=  
USERLIBS    	:=  
